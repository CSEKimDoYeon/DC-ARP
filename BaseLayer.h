...
public:
	...
	virtual	BOOL	Send(int) { return FALSE; }
	virtual	BOOL	Send() { return FALSE; }
	virtual	BOOL	Send(unsigned char*, int, int, unsigned char) 	{ return FALSE; }//used ChatLayer
	virtual	BOOL	Send( unsigned char*, int,int ) 	{ return FALSE ; }//used TCP
	...
	virtual BOOL	Receive(unsigned char*,unsigned char*) 	{ return FALSE; }
	virtual unsigned char* GetDestinAddress(){ return 0; }
	char*			m_pLayerName;
